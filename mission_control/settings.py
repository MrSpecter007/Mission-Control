...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-mission-control-dev-key-change-in-production'
)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'platforms.context_processors.updates_context',
            ],
        },
    },
]
...
CSRF_TRUSTED_ORIGINS = [
    x.strip()
    for x in os.environ.get('CSRF_TRUSTED_ORIGINS', 'http://localhost:8765').split(',')
    if x.strip()
]
